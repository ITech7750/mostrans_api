...
public class UIRenderer {
    ...
    public void sendMetroLineSelectionMenu(long chatId, LoadForecastTelegramBot bot) {
        ...
        // Линии метро
        String[] lines = {
                "Сокольническая линия", "Замоскворецкая", "Арбатско-Покровская линия",
                "Филевская линия", "Кольцевая линия", "Калужско-Рижская линия",
                "Таганско-Краснопресненская линия", "Калининско-Солнцевская линия",
                "Серпуховско-Тимирязевская линия", "Люблинско-Дмитровская линия",

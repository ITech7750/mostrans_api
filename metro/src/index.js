...
export function draw() {
    ...
    DC.extend(mopt, {
        ...
        sBKL:       st_mck(  {fg: mopt['rBKL'].fg,   anchor: ['start', 'middle']}),
        sBKL_1:     st_mck(  {fg: mopt['rBKL'].fg,   anchor: ['start', 'top']}),
        sBKL_2:     st_mck(  {fg: mopt['rBKL'].fg,   anchor: ['end',   'middle']}),
        sBKL_3:     st_mck(  {fg: mopt['rBKL'].fg,   anchor: ['end',   'bottom']}),
        sBKL_4:     st_mck(  {fg: mopt['rBKL'].fg,   anchor: ['start', 'bottom']}),
        sBKL_5:     inst_mck({fg: mopt['rBKL'].fg}),
        sBKL_6:     inst_mck({fg: mopt['rBKL'].fg,   anchor: ['start', 'top']}),
        sBKL_7:     inst_mck({fg: mopt['rBKL'].fg,   anchor: ['end',   'middle']}),
        sBKL_8:     inst_mck({fg: mopt['rBKL'].fg,   anchor: ['middle','bottom']}),
        sBKL_9:     inst_mck({fg: mopt['rBKL'].fg,   anchor: ['start', 'bottom']}),
